(function () {
    ...
    angular.module("blocktrail.wallet")
        .controller("BCHASendReplayProtectModal", BCHASendReplayProtectModal);

    function BCHASendReplayProtectModal($scope, $modalInstance, $log, $q, $timeout, $state, $translate,
