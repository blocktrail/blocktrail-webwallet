...
angular.module('blocktrail.wallet').config(
    function($stateProvider, $urlRouterProvider, $logProvider, $ionicAutoTrackProvider, CONFIG) {
        ...
        $stateProvider
            .state('app', {
                abstract: true,
                templateUrl: CONFIG.STATICSDIR + "/templates/common/base.html"
            })
            ...
            .state('app.setup', {
                ...
                templateUrl: CONFIG.STATICSDIR + "/templates/setup/setup.html"
            })
            .state('app.setup.login', {
                url: "/login",
                cache: false,
                controller: "SetupLoginCtrl",
                templateUrl: CONFIG.STATICSDIR + "/templates/setup/setup.login.html",
                resolve: {
            ...
            .state('app.setup.rebrand', {
                ...
                templateUrl: CONFIG.STATICSDIR + "/templates/setup/setup.rebrand.html"
            })
            .state('app.setup.register', {
                url: "/register",
                cache: false,
                controller: "SetupNewAccountCtrl",
                templateUrl: CONFIG.STATICSDIR + "/templates/setup/setup.register.html",
                resolve: {
                    handleSetupState: function($state, launchService) {
            ...
            .state('app.setup.forgotpass', {
                ...
                templateUrl: CONFIG.STATICSDIR + "/templates/setup/setup.forgotpass.html",
                resolve: {}
            })
            .state('app.setup.wallet', {
                ...
                templateUrl: CONFIG.STATICSDIR + "/templates/setup/setup.wallet.html",
                resolve: {
                    handleSetupState: function($state, launchService) {
            ...
            .state('app.setup.backup', {
                ...
                templateUrl: CONFIG.STATICSDIR + "/templates/setup/setup.wallet-backup.html",
                resolve: {
                    handleSetupState: function($state, launchService) {
            ...
            .state('app.wallet', {
                ...
                templateUrl: CONFIG.STATICSDIR + "/templates/wallet/wallet.html",
                resolve: {
                    handleSetupState: function($state, launchService) {
            ...
            .state('app.wallet.summary', {
                ...
                views: {
                    "mainView@app.wallet": {
                        templateUrl: CONFIG.STATICSDIR + "/templates/wallet/wallet.summary.html",
            ...
            .state('app.wallet.send', {
                ...
                views: {
                    "mainView@app.wallet": {
                        templateUrl: CONFIG.STATICSDIR + "/templates/send/send.input-screen.html",
                        controller: 'SendCtrl'
                    }
                }
            })
            ...
            .state('app.wallet.receive', {
                ...
                views: {
                    "mainView@app.wallet": {
                        templateUrl: CONFIG.STATICSDIR + "/templates/receive/receive.new-address.html",
            ...
            .state('app.wallet.settings', {
                ...
                views: {
                    "mainView@app.wallet": {
                        templateUrl: CONFIG.STATICSDIR + "/templates/settings/settings.html",
