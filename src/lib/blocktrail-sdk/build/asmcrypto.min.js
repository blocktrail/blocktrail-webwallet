!function(e, t) {
    ...
    function u(e) {
        ...
        }(t, null, this.heap.buffer), this.BLOCK_SIZE = x, this.HASH_SIZE = o, this.reset();
    }
    u.BLOCK_SIZE = x, u.HASH_SIZE = o;
    var l = u.prototype;
    l.reset = function() {
    ...
    var v = d.prototype;
    function m(e) {
        return (e = e || {}).hash instanceof u || (e.hash = (null === b && (b = new u({
            heapSize: 1048576
        })), b)), d.call(this, e), this;
    }
    v.reset = function(e) {
        var t = (e = e || {}).password;
        if (null === this.key && !a(t) && !t) throw new r("no key is associated with the instance");
        this.result = null, this.hash.reset(), (t || a(t)) && (this.key = p(this.hash, t));
        for (var s = new Uint8Array(this.key), c = 0; c < s.length; ++c) s[c] ^= 54;
        this.hash.process(s);
        var i = e.verify;
        return void 0 !== i ? w.call(this, i) : this.verify = null, this;
    }, v.process = y, v.finish = function() {
        if (null === this.key) throw new r("no key is associated with the instance");
        if (null !== this.result) throw new r("state must be reset before processing new data");
        ...
        return this;
    }, m.BLOCK_SIZE = u.BLOCK_SIZE, m.HMAC_SIZE = u.HASH_SIZE;
    var g = m.prototype;
    g.reset = function(e) {
        ...
        var s = e.verify;
        return void 0 !== s ? w.call(this, s) : this.verify = null, this;
    }, g.process = y, g.finish = function() {
        if (null === this.key) throw new r("no key is associated with the instance");
        if (null !== this.result) throw new r("state must be reset before processing new data");
        var e = this.hash, asm = this.hash.asm, t = this.hash.heap;
        asm.hmac_finish(e.pos, e.len, 0);
        var s = this.verify, c = new Uint8Array(o);
        if (c.set(t.subarray(0, o)), s) if (s.length === c.length) {
    ...
    var _ = S.prototype;
    function H(e) {
        return (e = e || {}).hmac instanceof m || (e.hmac = (null === E && (E = new m()), 
        E)), S.call(this, e), this;
    }
    _.reset = A, _.generate = function(e, t, c) {
        if (null !== this.result) throw new r("state must be reset before processing new data");
    ...
    var I = H.prototype;
    I.reset = A, I.generate = function(e, t, c) {
        if (null !== this.result) throw new r("state must be reset before processing new data");
        if (!e && !a(e)) throw new s("bad 'salt' value");
        t = t || this.count, c = c || this.length, this.result = new Uint8Array(c);
        for (var i = Math.ceil(c / this.hmac.HMAC_SIZE), n = 1; n <= i; ++n) {
